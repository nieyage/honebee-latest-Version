...
ORN<- readRDS("./05_ORN_cluster/02_second_cluster/06_rm_without_power/Unsupervised_ORN_remove_nopower_modify_the_tsne_order_by_tree.rds")
...
peak<-CallPeaks(
       ...
       outdir="./05_ORN_cluster/04_call_peak/",
       combine.peaks=TRUE
)
...
saveRDS(ORN,"./05_ORN_cluster/02_second_cluster/06_rm_without_power/Unsupervised_ORN_remove_nopower_modify_the_tsne_order_by_tree_recall_peak.rds")
